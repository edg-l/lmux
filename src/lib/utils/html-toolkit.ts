...
:root { --accent: #06b6d4; --bg: transparent; --fg: #e2e8f0; --border: #334155; --surface: rgba(30, 41, 59, 0.5); }
body { background: transparent; color: var(--fg); font-family: 'DM Sans', system-ui, -apple-system, sans-serif; line-height: 1.5; padding: 0.75rem; }
